    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 exportbtn">
                                    ...
                                    <button type="button" id="btn_update" title="Update Company Info" runat="server" onserverclick="update_info" class="btn btnsqr btn-primary5"><i class="fa fa-pencil-square-o"></i>Edit</button>
                                ...
                                <table id="example1" class="table table-bordered table-striped details">
                                    <thead>
                                        <tr>
                                            ...
                                            <td>
                                                <h5><b>
                                                    <asp:Label ID="lbl_company_name" runat="server" Text="Not Set"></asp:Label>
                                                </b></h5>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5><b>
                                                    <asp:Label ID="lbl_company_name2" runat="server" Text="Not Set"></asp:Label>
                                                </b></h5>
                                            </td>

                                        </tr>
                                        <tr>
                                            <th>Owner Names<span style="color: red;">*</span></th>
                                            <td>
                                                <asp:Label ID="lbl_owner_name" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Address<span style="color: red;">*</span></th>
                                            <td>
                                                <asp:Label ID="lbl_address" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Contact no.<span style="color: red;">*</span></th>
                                            <td>
                                                <asp:Label ID="lbl_contact" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>GST no.</th>
                                            <td>
                                                <asp:Label ID="lbl_gst" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Email ID<span style="color: red;">*</span></th>
                                            <td>
                                                <asp:Label ID="lbl_email" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Website</th>
                                            <td>
                                                <asp:Label ID="lbl_website" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Company Logo<span style="color: red;">*</span></th>
                                            <td>
                                        ...
                                        <asp:Panel ID="Panel2" runat="server">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button ID="Button1" Class="btn2 btnsqr btn-primary5 pull-right" OnClick="Logo_Update" runat="server" Text="Update"  OnClientClick="return JsfunctionLogo();"/>
                                        ...
                                        <tr>
                                            <th>Bank Name</th>
                                            <td>
                                                <asp:Label ID="lbl_bank_name" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Branch Name</th>
                                            <td>
                                                <asp:Label ID="lbl_branch" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Account Number</th>
                                            <td>
                                                <asp:Label ID="lbl_ac_no" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Bank Branch IFSC</th>
                                            <td>
                                                <asp:Label ID="lbl_ifsc" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>UPI Number</th>
                                            <td>
                                                <asp:Label ID="lblupino" runat="server" Text="Not Set"></asp:Label>
                                            </td>
                                        </tr>
                                    </thead>
                                ...
                                <div class="card-body">
                                    <div class="form-horizontal form-bordered">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Owner Name <span style="color: red;">*</span></label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:TextBox ID="Txt_acc_no" placeholder="Bank Account Number" class="form-control" runat="server" TextMode="Number"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="offset-sm-3 col-md-9">
                                                            ...
                                                            <asp:Button ID="Btn_submit" class="btn btn-success" OnClientClick="return JSFunctionValidate();" runat="server" Text="Update" OnClick="Btn_submit_Click" />
        ...
        <script>
            function JSFunctionValidate() {
                ...
                if (document.getElementById('<%=Txt_company_name.ClientID%>').value.length == 0) {
               alert("Please Enter Company Name !!!");
               return false;
           }
           if (document.getElementById('<%=Txt_owner_name.ClientID%>').value.length == 0) {
           ...
           if (document.getElementById('<%=Txt_email.ClientID%>').value.length == 0) {
                ...
                <%--if (document.getElementById('<%=lbl_logo.ClientID%>').value.length == 0) {
            ...
            function JsfunctionLogo() {

               

                if (document.getElementById('<%=lbl_logo.ClientID%>').value=="") {
                       alert("Please Upload Company Logo !!!");
                       return false;
                   }
