                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"></th>
                                            <th scope="col"></th>
                                            <th scope="col" style="text-align:right;"><asp:LinkButton ID="Btn_cart" Style="margin-right: 5px;" OnClientClick="return JSFunctionValidate4();" OnClick="Btn_cart_Click" runat="server"><i style="padding-left:10px; font-size:40px;" class="fa fa-plus-circle"></i></asp:LinkButton>
                                              </th>
                                ...
                                <div class="row">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"><asp:CheckBox ID="Chk_pasting" runat="server" /> Pasting &nbsp<asp:CheckBox ID="Chk_framing" runat="server" /> Framing <%--<asp:CheckBox ID="CheckBox7" runat="server" />--%> Charges:</th>

                                            

                                            <th scope="col"><asp:CheckBox ID="Chk_fitting" runat="server" /> Fitting &nbsp<asp:CheckBox ID="Chk_install" runat="server" /> Installation <%--<asp:CheckBox ID="CheckBox5" runat="server" />--%> Charges:</th>
