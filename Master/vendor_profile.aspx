...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tbody>
      ...
      <th scope="col">Contact</th>
      <td>
          <asp:TextBox ID="Txt_contact" CssClass="form-control" runat="server"></asp:TextBox></td>
     
    </tr>
       <tr>
      <th scope="col">Alternate Contact</th>
      <td>
          <asp:TextBox ID="Txt_contact2" CssClass="form-control" runat="server"></asp:TextBox></td>
      ...
      <th scope="col">Opening Balance</th>
      <td>
          <asp:TextBox ID="Txt_opening_balance" CssClass="form-control" runat="server"></asp:TextBox></td>
      ...
      <div class="table-responsive">
          ...
          <asp:Repeater ID="Repeater2" runat="server" OnItemDataBound="Repeater2_ItemDataBound">
              ...
              <asp:Label ID="lbl_invoice" runat="server" Text='<%# Eval("pu_invoice_no") %>'></asp:Label></td>
                        <td><asp:Label ID="lbl_date" runat="server" Text='<%# Eval("pu_invoice_date", "{0:dd/MM/yyyy}") %>'></asp:Label></td>
      ...
      <div class="table-responsive">
          ...
          <asp:Repeater ID="Repeater4" runat="server">
              ...
              <asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("pi_due") %>'></asp:Label></td>
                  <td><asp:Label ID="lbl_advance" runat="server" Text='<%# Eval("pi_pay") %>'></asp:Label></td>
                  <td><asp:Label ID="lbl_mode" runat="server" Text='<%# Eval("pi_mode") %>'></asp:Label></td>
                       <td><asp:Label ID="lbl_total" runat="server" Text='<%# Eval("pi_balance") %>'></asp:Label></td>
