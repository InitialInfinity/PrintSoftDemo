<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="list_of_product.aspx.cs" Inherits="Master_list_of_product" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i>List of Product</li>
            </ol>
        </section>
                                        ...
                                        <div class="form-horizontal form-bordered">
                                            <div class="row">
                                                <div class="col-md-4" style="padding: 15px">
                                                    ...
                                                    <h4 class="text-black">Sale Product List</h4>
                                                </div>
                                                <div class="col-md-8 exportbtn">
                                                    <a href="add_product.aspx">
                                                        <button type="button" id="btn_mail" title="Add New Product" class="btn btn-primary4"><i class="fa fa-plus"></i>Add Product</button></a>
                                                                ...
                                                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="lbl_unit" runat="server" Text='<%# Eval("p_unit") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_cgst" runat="server" Text='<%# Eval("p_cgst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_sgst" runat="server" Text='<%# Eval("p_sgst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_igst" runat="server" Text='<%# Eval("p_igst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_hsn" runat="server" Text='<%# Eval("p_hsn_code") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("p_rate") %>'></asp:Label></td>
                                ...
                                <div class="pad-20">
                                    <div class="card-body">
                                        <div class="form-horizontal form-bordered">
                                            <div class="row">
                                                <div class="col-md-4" style="padding: 15px">
                                                    <h4 class="text-black">Purchase Product List</h4>
                                                </div>

                                                <div class="col-md-8 exportbtn">
                                                    <a href="add_product.aspx">
                                                        <button type="button" title="Add New Customer" class="btn btn-primary4"><i class="fa fa-plus"></i>Add Product</button></a>
                                                                ...
                                                                <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td><strong>
                                                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("p_stock") %>'></asp:Label><strong /></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_unit2" runat="server" Text='<%# Eval("p_unit") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_cgst2" runat="server" Text='<%# Eval("p_cgst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_sgst2" runat="server" Text='<%# Eval("p_sgst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_igst2" runat="server" Text='<%# Eval("p_igst") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_hsn2" runat="server" Text='<%# Eval("p_hsn_code") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_rate2" runat="server" Text='<%# Eval("p_rate") %>'></asp:Label></td>

                                                                            <td class="no-print">
                                                                                <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Do you want to delete this Product?');" OnClick="DeleteProduct2"><i  class="fa fa-trash-o"></i></asp:LinkButton>
                                                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="showid" CommandArgument='<%# Eval("p_id") %>'><i style="padding-left:10px" class="fa fa-eye"></i></i></asp:LinkButton>
                                                                                <asp:LinkButton ID="LinkButton3" runat="server" CommandName="editid" CommandArgument='<%# Eval("p_id") %>'><i style="padding-left:10px" class="fa fa-edit"></i></asp:LinkButton>
                                                                                <!--<a href=""></a><a href=""><i style="padding-left:10px" class="fa fa-edit"></i></a><a href="" runat="server" ><i style="padding-left:10px" class="fa fa-trash-o"></i></a>-->
                                                                            </td>
  ...
  <!-- /.content-wrapper -->
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lbl_sgst" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">IGST</th>
                                <td>
                                    <asp:Label ID="lbl_igst" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">HSN Code</th>
                                <td>
                                    <asp:Label ID="lbl_hsn_code" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">Rate</th>
                                <td>
                                    <asp:Label ID="lbl_rate" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">Description</th>
                                <td>
                                    <asp:Label ID="lbl_desc" runat="server" Text=""></asp:Label></td>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="Txt_name" class="form-control" runat="server"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="Dd_unit" class="form-control" runat="server">
                                        <asp:ListItem Value="Sqft"></asp:ListItem>
                                        <asp:ListItem Value="Inch"></asp:ListItem>
                                        <asp:ListItem Value="Pcs"></asp:ListItem>
                                        <asp:ListItem Value="Packet"></asp:ListItem>
                            ...
                            <tr>
                                <th scope="col">HSN Code</th>
                                <td>
                                    <asp:TextBox ID="Txt_hsn" class="form-control" runat="server"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Rate</th>
                                <td>
                                    <asp:TextBox ID="Txt_rate" placeholder="Rate" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Description</th>
                                <td>
                                    <asp:TextBox ID="Txt_description" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox></td>
    ...
    <div class="modal fade" id="myModal3" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <asp:Label ID="lbl_name2" runat="server" Text=""></asp:Label></h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th scope="col">Unit</th>
                                <td>
                                    <asp:Label ID="lbl_unit2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">CGST</th>
                                <td>
                                    <asp:Label ID="lbl_cgst2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">SGST</th>
                                <td>
                                    <asp:Label ID="lbl_sgst2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">IGST</th>
                                <td>
                                    <asp:Label ID="lbl_igst2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">HSN Code</th>
                                <td>
                                    <asp:Label ID="lbl_hsn_code2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">Rate</th>
                                <td>
                                    <asp:Label ID="lbl_rate2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">Stock</th>
                                <td>
                                    <asp:Label ID="lbl_stock2" runat="server" Text=""></asp:Label></td>

                            </tr>
                            <tr>
                                <th scope="col">Description</th>
                                <td>
                                    <asp:Label ID="lbl_desc2" runat="server" Text=""></asp:Label></td>
    ...
    <div class="modal fade" id="myModal4" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Panel<asp:HiddenField ID="Txt_id2" runat="server" />
                    </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th scope="col">Product Name</th>
                                <td>
                                    <asp:TextBox ID="Txt_name2" class="form-control" runat="server"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Unit</th>
                                <td>
                                    <asp:DropDownList ID="Dd_unit2" class="form-control" runat="server">
                                        <asp:ListItem Value="Sqft"></asp:ListItem>
                                        <asp:ListItem Value="Inch"></asp:ListItem>
                                        <asp:ListItem Value="Pcs"></asp:ListItem>
                                        <asp:ListItem Value="Packet"></asp:ListItem>
                            ...
                            <tr>
                                <th scope="col">CGST</th>
                                <td>
                                    <asp:DropDownList ID="Dd_cgst2" class="form-control" runat="server">
                                        <asp:ListItem Value="0">0 %</asp:ListItem>
                                        <asp:ListItem Value="5">5 %</asp:ListItem>
                                        <asp:ListItem Value="6">6 %</asp:ListItem>
                                        <asp:ListItem Value="9">9 %</asp:ListItem>
                            ...
                            <tr>
                                <th scope="col">SGST</th>
                                <td>
                                    <asp:DropDownList ID="Dd_sgst2" class="form-control" runat="server">
                                        <asp:ListItem Value="0">0 %</asp:ListItem>
                                        <asp:ListItem Value="5">5 %</asp:ListItem>
                                        <asp:ListItem Value="6">6 %</asp:ListItem>
                                        <asp:ListItem Value="9">9 %</asp:ListItem>
                            ...
                            <tr>
                                <th scope="col">IGST</th>
                                <td>
                                    <asp:DropDownList ID="Dd_igst2" class="form-control" runat="server">
                                        <asp:ListItem Value="0">0 %</asp:ListItem>
                                        <asp:ListItem Value="5">5 %</asp:ListItem>
                                        <asp:ListItem Value="6">6 %</asp:ListItem>
                                        <asp:ListItem Value="9">9 %</asp:ListItem>
                            ...
                            <tr>
                                <th scope="col">HSN Code</th>
                                <td>
                                    <asp:TextBox ID="Txt_hsn2" class="form-control" runat="server"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Rate</th>
                                <td>
                                    <asp:TextBox ID="Txt_rate2" placeholder="Rate" class="form-control" runat="server"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Stock</th>
                                <td>
                                    <asp:TextBox ID="Txt_stock2" class="form-control" runat="server"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <th scope="col">Description</th>
                                <td>
                                    <asp:TextBox ID="Txt_description2" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox></td>
    ...
    <script>
        ...
        function JSFunctionValidate2() {
            if (document.getElementById('<%=Txt_name2.ClientID%>').value.length == 0) {
                alert("Please Enter Product Name !!!");
                return false;
            }

            if (document.getElementById('<%=Txt_rate2.ClientID%>').value.length == 0) {
                alert("Please Enter Product's Rate  !!!");
                return false;
            }
