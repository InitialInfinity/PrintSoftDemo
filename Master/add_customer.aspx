                ...
                <div class="form-body">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-md-9">
                       <asp:TextBox ID="Txt_contact"   placeholder="Contact no." class="form-control" MaxLength="10" runat="server" TextMode="Number" TabIndex="3"></asp:TextBox>
                      </div>
                  </div>
                    <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <asp:TextBox ID="Txt_gst_no" placeholder="GST no." class="form-control" runat="server" TabIndex="5"></asp:TextBox>
                    </div>
                  </div>
                  <div class="form-group row">
...
return false;
    ...
    if (!(document.getElementById('<%=Txt_contact.ClientID%>').value.length == 10)) && (!(^[0-9]*$.test(document.getElementById('<%=Txt_contact.ClientID%>').value))
{
...
return false;
    ...
    if (!(^[A-Za-z0-9]*$.test(document.getElementById('<%=Txt_gst_no.ClientID%>').value)) && !(document.getElementById('<%=Txt_gst_no.ClientID%>').value.length == 15)) {
        alert("You Have Entered an Invalid Gst No!");
        return false;
    }
