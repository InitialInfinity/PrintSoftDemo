<%@ Page Title="" Language="C#" MasterPageFile="~/Roll Purchase/RollPurchase.master" AutoEventWireup="true" CodeFile="roll_bill.aspx.cs" Inherits="Purchase_roll_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <strong>Success!</strong> Purchase Invoice successfully updated!
      ...
      <div class="exportbtn">
         ...
         <button type="button" id="Button1" onclick="printdiv('dropHere');" title="Print Format-1" class="btn btnsqr btn-primary6 "> <i class="fa fa-print"></i> Print</button>
 ...
 <ItemTemplate>
    <tr>
      <td>
          <asp:Label ID="lbl_product" runat="server" Text='<%# Eval("rpc_product_name") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_hsn" runat="server" Text='<%# Eval("rpc_product_hsn") %>'></asp:Label></td>
        <td><asp:Label ID="lbl_igst" runat="server" Text='<%# Eval("rpc_size") %>'></asp:Label></td>
    
    <td><asp:Label ID="Label4" runat="server" Text='<%# Eval("rpc_unit") %>'></asp:Label></td>
          <td><asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("rpc_quantity") %>'></asp:Label></td>
       
      <td><asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("rpc_rate") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_stotal" runat="server" Text='<%# Eval("rpc_stotal") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_cgst" runat="server" Text='<%# Eval("rpc_cgsta") %>'></asp:Label></td>

      <td><asp:Label ID="lbl_sgst" runat="server" Text='<%# Eval("rpc_sgsta") %>'></asp:Label></td>
        <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("rpc_igsta") %>'></asp:Label></td>
      

    <td><asp:Label ID="lbl_amount" runat="server" Text='<%# Eval("rpc_amount") %>'></asp:Label></td>
    </tr>
       </ItemTemplate>
