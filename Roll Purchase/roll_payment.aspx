<%@ Page Title="" Language="C#" MasterPageFile="~/Roll Purchase/RollPurchase.master" AutoEventWireup="true" CodeFile="roll_payment.aspx.cs" Inherits="Purchase_roll_payment" %>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                         <asp:TextBox ID="Txt_date" class="form-control" placeholder="Advance" runat="server" TextMode="Date" TabIndex="3"></asp:TextBox>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="offset-sm-3 col-md-9">
                                                                ...
                                                                <asp:Button ID="Btn_submit" class="btn btn-success" runat="server" Text="Pay" OnClientClick="return JSFunctionValidate()" OnClick="Btn_submit_Click" TabIndex="4"/>
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("rpi_date", "{0:dd/MM/yyyy}") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_invoice" runat="server" Text='<%# Eval("rpi_invoice") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_customer" runat="server" Text='<%# Eval("v_name") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_due" runat="server" Text='<%# Eval("rpi_due") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_pay" runat="server" Text='<%# Eval("rpi_pay") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_mode" runat="server" Text='<%# Eval("rpi_mode") %>'></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("rpi_balance") %>'></asp:Label></td>
