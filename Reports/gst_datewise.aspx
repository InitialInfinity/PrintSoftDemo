                ...
                <div class="col-lg-3">
                    <div class="tile-progress tile-pink">
                        <div class="tile-header">
                            ...
                            <h3>₹
                                <asp:Label ID="lbl_total_cgst" runat="server" Text=""></asp:Label></h3>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="tile-progress tile-red">
                        <div class="tile-header">
                            ...
                            <h3>₹
                                <asp:Label ID="lbl_total_sgst" runat="server" Text=""></asp:Label></h3>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="tile-progress tile-cyan">
                        <div class="tile-header">
                            ...
                            <h3>₹
                                <asp:Label ID="lbl_total_igst" runat="server" Text=""></asp:Label></h3>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="tile-progress tile-aqua">
                        <div class="tile-header">
                            ...
                            <h3>₹
                                <asp:Label ID="lbl_total_gst" runat="server" Text=""></asp:Label></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 exportbtn">
                            ...
                            <button type="button" id="btn_print" title="Print" onclick="checkDataAndPrint();" class="btn btnsqr btn-primary btngap"><i class="fa fa-print"></i>Print</button>
