<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="sale_worksheet.aspx.cs" Inherits="Reports_sale_monthly_worksheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Sale Worksheet</h1>
      <ol class="breadcrumb">
        <li><a href="#">Reports</a></li>
        <li><i class="fa fa-angle-right"></i> Sale Worksheet</li>
      </ol>
    </section>
     <section class="content">
      ...
      <div class="card-body">
       <div class="row">
        <div class="col-md-5">
         <h4 class="text-black">Sale Worksheet</h4>
        </div>
        ...
        <section class="invoice"> 
          ...
          <div class="row">
            <div class="col-lg-12 m-b-3">
              <h3 class="text-black">
                 <span class="pull-right">Sale Worksheet</span> </h3>
            </div>
            <!-- /.col --> 
          </div>
          <!-- info row -->
 ...
 <ItemTemplate>
    <tr>
      <td>
          <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("s_date", "{0:dd/MM/yyyy}") %>'></asp:Label></td>
        <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("s_product_name") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_height" runat="server" Text='<%# Eval("s_height") %>'></asp:Label> X <asp:Label ID="lbl_width" runat="server" Text='<%# Eval("s_width") %>'></asp:Label></td>
        <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("s_rate") %>'></asp:Label></td>
        <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("s_quantity") %>'></asp:Label></td>
      ...
      <td><asp:Label ID="lbl_sgst" runat="server" Text='<%# Eval("s_sgstp") %>'></asp:Label></td>
       <td><asp:Label ID="lbl_payment" runat="server" Text='<%# Eval("s_amount") %>'></asp:Label></td>
