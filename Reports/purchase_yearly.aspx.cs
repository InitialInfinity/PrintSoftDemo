...
public partial class Reports_purchase_yearly : System.Web.UI.Page
{
    ...
    protected void excel_export(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=List of Yearly Purchase Invoice-" + date + ".xls");
    ...
    protected void pdf_export(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=List of Yearly Purchase Invoice-" + date + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
