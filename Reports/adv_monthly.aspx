<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="adv_monthly.aspx.cs" Inherits="Reports_adv_monthly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Advance Report - Monthly</h1>
      <ol class="breadcrumb">
        <li><a href="#">Reports</a></li>
        <li><i class="fa fa-angle-right"></i>Advance Report - Monthly</li>
      </ol>
    </section>
    <section class="content">
      ...
      <div class="row">
         ...
         <div class="tile-progress tile-cyan">
            ...
            <div class="tile-footer">
              <h5>Monthly Total Business Details</h5>
            </div>
          </div>
         </div>
      </div>
       ...
       <div class="row">
        <div class="col-xl-6">
         ...
         <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Monthly Estimate Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
      ...
      <!-- /.row -->
        ...
        <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Monthly Purchase Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
         ...
         <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Monthly Expense Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
      ...
      <!-- /.row -->
        ...
        <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Monthly Salary Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                    <asp:Repeater ID="Repeater6" runat="server">
                        <ItemTemplate>
                  <tr>
                    <td><asp:Label ID="lbl_date" runat="server" Text='<%# Eval("si_date","{0:dd/MM/yyyy}") %>'></asp:Label></td>
                  <td>
