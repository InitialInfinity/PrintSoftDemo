      ...
      <div id="dropHere"  class="table-responsive">
          ...
          <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
              ...
              <td><asp:Label ID="lbl_cat" runat="server" Text='<%# Eval("e_category_name") %>'></asp:Label></td>
                  ...
                  <td class="no-print">
                  <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Do you want to delete this Expense Invoice?');" OnClick="DeleteSale" style="display:none"><i  class="fa fa-trash-o"></i></asp:LinkButton>
                 <asp:LinkButton ID="LinkButton2" runat="server"  CommandName="showid" CommandArgument='<%# Eval("e_id") %>'><i style="padding-left:10px" class="fa fa-eye"></i></asp:LinkButton>
                  <asp:LinkButton ID="LinkButton3" runat="server" CommandName="editid" CommandArgument='<%# Eval("e_id") %>' style="display:none"><i style="padding-left:10px" class="fa fa-edit"></i></asp:LinkButton>
