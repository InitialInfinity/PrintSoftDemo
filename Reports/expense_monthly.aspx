<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="expense_monthly.aspx.cs" Inherits="Reports_expense_monthly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Expense Report - Monthly</h1>
      <ol class="breadcrumb">
        <li><a href="#">Reports</a></li>
        <li><i class="fa fa-angle-right"></i>Expense Report - Monthly</li>
      </ol>
    </section>
          ...
          <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
              ...
              <td><asp:Label ID="lbl_cat" runat="server" Text='<%# Eval("e_category_name") %>'></asp:Label></td>
                 ...
                 <asp:LinkButton ID="LinkButton2" runat="server"  CommandName="showid" CommandArgument='<%# Eval("e_id") %>'><i style="padding-left:10px" class="fa fa-eye"></i></asp:LinkButton>
                  <asp:LinkButton ID="LinkButton3" runat="server" CommandName="editid" style="display:none" CommandArgument='<%# Eval("e_id") %>'><i style="padding-left:10px" class="fa fa-edit"></i></asp:LinkButton>
