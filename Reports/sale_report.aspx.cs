...
public partial class Reports_sale_report : System.Web.UI.Page
{
    ...
    public void customer()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            Dd_customer.DataTextField = "st_staff_name";
            Dd_customer.DataValueField = "st_id";
            Dd_customer.DataBind();
    ...
    {
        SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_staff on tbl_sale.sl_order_ref=tbl_staff.st_staff_name order by sl_id desc", conn);
    ...
    protected void Btn_search_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_staff on tbl_sale.sl_order_ref=tbl_staff.st_staff_name where  tbl_sale.sl_order_ref='" + 0 + "' Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count == 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_staff on tbl_sale.sl_order_ref=tbl_staff.st_staff_name where  tbl_sale.sl_order_ref='" + Dd_customer.SelectedItem.Text + "' Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_staff on tbl_sale.sl_order_ref=tbl_staff.st_staff_name where sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "' Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_staff on tbl_sale.sl_order_ref=tbl_staff.st_staff_name  where tbl_sale.sl_order_ref='" + Dd_customer.SelectedItem.Text + "' AND sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "'  Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
