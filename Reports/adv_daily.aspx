<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="adv_daily.aspx.cs" Inherits="Reports_adv_daily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Advance Report - Daily</h1>
      <ol class="breadcrumb">
        <li><a href="#">Reports</a></li>
        <li><i class="fa fa-angle-right"></i>Advance Report - Daily</li>
      </ol>
    </section>
    <section class="content">
      ...
      <div class="row">
         ...
         <div class="tile-progress tile-cyan">
            ...
            <div class="tile-footer">
              <h5>Today's Total Business Details</h5>
            </div>
          </div>
         </div>
      </div>
       ...
       <div class="row">
        <div class="col-xl-6">
         ...
         <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Daily Estimate Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
      ...
      <!-- /.row -->
        ...
        <div class="col-xl-6">
         ...
         <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Daily Expense Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
      ...
      <!-- /.row -->
        ...
        <div class="col-xl-6">
          <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Daily Salary Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
         ...
         <div class="col-xl-6">
           <div class="info-box">
            <div class="card-header">
              <h5 class="card-title">Daily Payment Report</h5>
            </div>
            <div class="table-responsive" style="height:250px;">
              <table class="table table-hover">
                <thead>
