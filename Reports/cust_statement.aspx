<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="cust_statement.aspx.cs" Inherits="Reports_cust_statement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Customer Statement</li>
      </ol>
    </section>
     <section class="content">
      ...
      <div class="card-body">
       <div class="row">
        <div class="col-md-5">
         <h4 class="text-black">Customer Statement</h4>
        </div>
         ...
         <div class="col-md-3">
          ...
          <div class="col-md-3">
           ...
           <div class="col-md-3">
            ...
            <asp:Button ID="Btn_Search" runat="server" Text="Search" OnClick="Btn_Search_Click" class="btn btnsqr btn-primary "/>
        ...
        <section class="invoice"> 
          ...
          <div class="row">
            <div class="col-lg-12 m-b-3">
              <h3 class="text-black">
                 <span class="pull-right">Customer Statement </span> </h3>
            </div>
            <!-- /.col --> 
          </div>
          <!-- info row -->
 ...
 <ItemTemplate>
    <tr>
      <td>
          <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("si_date", "{0:MM/dd/yyyy}") %>'></asp:Label></td>
        <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("si_invoice") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_amount" runat="server" Text='<%# Eval("si_due") %>'></asp:Label></td>
        <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("si_discount") %>'></asp:Label></td>
       <td><asp:Label ID="lbl_payment" runat="server" Text='<%# Eval("si_pay") %>'></asp:Label></td>
    <td><asp:Label ID="lbl_payment_mode" runat="server" Text='<%# Eval("si_mode") %>'></asp:Label></td>
          <td><asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("si_balance") %>'></asp:Label></td>
