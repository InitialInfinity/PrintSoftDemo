...
public partial class Reports_sale_monthly_worksheet : System.Web.UI.Page
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        {
            Panel1.Visible = true;
            cmd2 = new SqlCommand("select * from tbl_sale_invoice where c_id ='" + Dd_customer.SelectedItem.Value + "'", conn);
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                lbl_invoice_amount.Text = dt1.Compute("Sum(s_amount)", string.Empty).ToString();
            ...
            //cmd7 = new SqlCommand("select sum(sl_balance) from tbl_sale where sl_customer_name='" + Dd_customer.SelectedItem.Text + "'", conn);
        ...
        else if (Date1.Text == "" || Date2.Text == "" && Dd_customer.SelectedItem.Text != "--Select--")
        {
            Panel1.Visible = true;
            cmd2 = new SqlCommand("select * from tbl_sale_invoice where c_id ='" + Dd_customer.SelectedItem.Value + "' AND s_date between '" + Date1.Text + "' AND '" + Date2.Text + "'", conn);
            adapt2 = new SqlDataAdapter(cmd2);
            dt1 = new DataTable();
            adapt2.Fill(dt1);
            if (dt1.Rows.Count > 0)
            ...
            cmd7 = new SqlCommand("select sum(sl_balance) from tbl_sale where c_id='" + Dd_customer.SelectedItem.Value + "' AND sl_date between '" + Date1.Text + "' AND '" + Date2.Text + "' ", conn);
            adapt7 = new SqlDataAdapter(cmd7);
            dt7 = new DataTable();
            adapt7.Fill(dt7);
            if (dt7.Rows.Count > 0)
        ...
        {
			Panel1.Visible = true;
			cmd2 = new SqlCommand("select * from tbl_sale_invoice where  s_date between '" + Date1.Text + "' AND '" + Date2.Text + "'", conn);
			adapt2 = new SqlDataAdapter(cmd2);
			dt1 = new DataTable();
			adapt2.Fill(dt1);
			if (dt1.Rows.Count > 0)
			...
			cmd7 = new SqlCommand("select sum(sl_balance) from tbl_sale where  sl_date between '" + Date1.Text + "' AND '" + Date2.Text + "' ", conn);
			adapt7 = new SqlDataAdapter(cmd7);
			dt7 = new DataTable();
			adapt7.Fill(dt7);
			if (dt7.Rows.Count > 0)
