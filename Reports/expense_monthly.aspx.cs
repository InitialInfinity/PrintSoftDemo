...
public partial class Reports_expense_monthly : System.Web.UI.Page
{
    ...
    protected void excel_export(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var da = new SqlDataAdapter("Select CONVERT(VARCHAR(10),e_date, 103) as [Date],e_user_name as [User],e_category_name as [Category],e_amount as [Amount],e_desc as [Description] From tbl_expense WHERE e_date >= DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE()), 0) AND e_date <  DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE()) + 1, 0)  Order By e_id desc", conn);
            ...
            Response.AddHeader("content-disposition", "attachment;filename=List of Monthly Expense-" + date + ".xls");
    ...
    protected void pdf_export(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=List of Monthly Expense-" + date + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string redirectScript = " window.location.href = 'expense_monthly.aspx';";
