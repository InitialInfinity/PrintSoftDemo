...
public partial class Reports_out_datewise : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("Select * From tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id WHERE sl_balance>0 Order By sl_id desc", conn);
    ...
    protected void Btn_search_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * From tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where tbl_sale.c_id= '" + Dd_customer.SelectedValue + "' AND sl_balance>0 Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * From tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where (sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "') AND sl_balance>0 Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * From tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where tbl_sale.c_id = '" + Dd_customer.SelectedValue + "' AND (sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "') AND sl_balance>0  Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
