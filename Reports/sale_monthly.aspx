                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>">
                                                            <asp:Label ID="lbl_date" runat="server" Text='<%# Eval("sl_date", "{0:dd/MM/yyyy}") %>'></asp:Label></a>
                                                        ...
                                                        <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>">
                                                            <asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("sl_adjustment") %>'></asp:Label></a>

                                                        </td>


                                                        <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>">
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("sl_balance") %>'></asp:Label></a>
