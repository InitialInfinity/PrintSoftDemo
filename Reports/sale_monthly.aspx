<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="sale_monthly.aspx.cs" Inherits="Reports_sale_monthly" %>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i>Sales Report - Monthly</li>
      </ol>
    </section>
              ...
              <asp:Label ID="lbl_invoice" runat="server" Text='<%# Eval("sl_invoice_no") %>'></asp:Label></a></td>
                ...
                <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_cust_name" runat="server" Text='<%# Eval("c_name") %>'></asp:Label></a></td>
                      <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_status" runat="server" Text=''></asp:Label></a></td>
                       <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("sl_adjustment") %>'></asp:Label></a></td>
                   
                       
                           <td><a href="../Sale/bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="Label1" runat="server" Text='<%# Eval("sl_balance") %>'></asp:Label></a></td>
