...
public partial class Reports_datewise_pymnt_mode : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmd = new SqlCommand("select * from tbl_sale where sl_payment_method = '" + Dd_customer.SelectedItem.Text+"' order by sl_id desc", conn);
    ...
    {
        if (Txt_date1.Text == "" && Txt_date1.Text == "" && Dd_customer.SelectedItem.Text != "--Select--")
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where tbl_sale.sl_payment_method = '" + Dd_customer.SelectedItem.Text + "' order by sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where tbl_sale.sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "' Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from tbl_sale inner join tbl_customer on tbl_sale.c_id=tbl_customer.c_id where tbl_sale.sl_payment_method = '" + Dd_customer.SelectedItem.Text + "' AND sl_invoice_date Between '" + Txt_date1.Text + "' and '" + Txt_date2.Text + "'  Order By sl_id desc", conn);
            SqlDataAdapter adapt = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
