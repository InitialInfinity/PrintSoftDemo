<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="sale_report.aspx.cs" Inherits="Reports_sale_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header sty-one">
            <h1>Sales Report - Designer wise</h1>
            <ol class="breadcrumb">
                <li><a href="#">Reports</a></li>
                <li><i class="fa fa-angle-right"></i>Sales Report - Designer wise</li>
            </ol>
        </section>
                ...
                <div class="card-body">
                    ...
                    <div class="row no-print" style="background-color: #dee2e6; height: 52px">
                        ...
                        <div class="col-md-1 padding_10 d-flex align-items-center justify-content-end">
                            <b>
                                <asp:Label ID="Label2" runat="server" Text="From"></asp:Label></b>
                        </div>
                        <div class="col-md-3 padding_3" style="margin-top: 8px">
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbl_cust_name" runat="server" Text='<%# Eval("sl_order_ref") %>'></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbl_status" runat="server" Text=''></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("sl_adjustment") %>'></asp:Label></td>
                                                    <td>
                                                    ...
                                                    <td class="no-print">
                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Do you want to delete this Sale Invoice?');" Style="display: none" OnClick="DeleteSale"><i  class="fa fa-trash-o"></i></asp:LinkButton>
