<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reports.master" AutoEventWireup="true" CodeFile="expense_daily.aspx.cs" Inherits="Reports_expense_daily" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Expense Report - Daily</h1>
      <ol class="breadcrumb">
        <li><a href="#">Reports</a></li>
        <li><i class="fa fa-angle-right"></i>Expense Report - Daily</li>
      </ol>
    </section>
        ...
        <div class="row">
          ...
          <div class="tile-progress tile-green">
            <div class="tile-header">
              ...
              <h3><asp:Label ID="lbl_count" runat="server" Text=""></asp:Label></h3>
            </div>
           
            <div class="tile-footer">
              <h6>Daily Copy Counter</h6>
            </div>
          </div>
        </div>
