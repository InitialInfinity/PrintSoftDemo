...
public partial class admin_panel_Quotation_gst_bill : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("gst_bill2.aspx?invoice=" + lbl_invoice_no.Text);
    ...
    public void fill()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //lbl_cgst1.Text = dt.Rows[0]["q_cgsta"].ToString();
            lbl_cgst1.Text = dt.Compute("Sum(q_cgsta)", string.Empty).ToString(); 
            //lbl_sgst1.Text = dt.Rows[0]["q_sgsta"].ToString();
            lbl_sgst1.Text = dt.Compute("Sum(q_sgsta)", string.Empty).ToString();
            lbl_dtp.Text = dt.Rows[0]["q_dtp_charges"].ToString();
            lbl_fitting.Text = dt.Rows[0]["q_fitting_charges"].ToString();
            lbl_pasting.Text = dt.Rows[0]["q_pasting_charges"].ToString();
            lbl_tranport.Text = dt.Rows[0]["q_shipping_charges"].ToString();
            //lbl_adjustment.Text = dt.Rows[0]["q_adjustment"].ToString();
            //lbl_balance.Text = dt.Rows[0]["q_balance"].ToString();
            //lbl_payment_method.Text = dt.Rows[0]["q_payment_method"].ToString();
