                            ...
                            <tbody>
                                ...
                                <tbody>
                                   <asp:Repeater ID="Repeater1" runat="server">
                                     <ItemTemplate>
                                    <tr class="table_td">
                                        <td><strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("qw_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("qw_desc") %>'></asp:Label> </td>
