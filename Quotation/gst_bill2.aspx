<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gst_bill2.aspx.cs" Inherits="Sale_bill2" %>
                            ...
                            <tbody>
                                ...
                                <tbody>
                                   <asp:Repeater ID="Repeater2" runat="server">
                                     <ItemTemplate>
                                    <tr class="table_td">
                                        <td><strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("q_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("q_desc") %>'></asp:Label> </td>
                                        <td><asp:Label ID="lbl_hsn" runat="server" Text='<%# Eval("q_hsn") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_height" runat="server" Text='<%# Eval("q_height") %>'></asp:Label> X <asp:Label ID="lbl_width" runat="server" Text='<%# Eval("q_width") %>'></asp:Label></td>
                                        <td><asp:Label ID="Label4" runat="server" Text='<%# Eval("q_unit") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("q_quantity") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("q_rate") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_stotal" runat="server" Text='<%# Eval("q_stotal") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_cgst" runat="server" Text='<%# Eval("q_cgstp") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_sgst" runat="server" Text='<%# Eval("q_sgstp") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_igst" runat="server" Text='<%# Eval("q_igstp") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_amount" runat="server" Text='<%# Eval("q_amount") %>'></asp:Label></td>
                                    </tr>
                                   </ItemTemplate>
                                  </asp:Repeater>
                                </tbody>
