                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_final_amt" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>
        ...
        function quan_amount2() {
         ...
         function final_total() {
           ...
           if (document.getElementById('<%=Txt_Dtp_charges.ClientID %>').value == '' && document.getElementById('<%=Txt_Fitting.ClientID%>').value == '' && document.getElementById('<%=Txt_Pasting.ClientID%>').value == '' && document.getElementById('<%=Txt_TransportCharges.ClientID %>').value == '')
            ...
            var total_amount = (parseFloat(subtotal.value) + parseFloat(total_dtp_transport) + parseFloat(fitting_value) + parseFloat(pasting_value) + parseFloat(totalgst.value));
