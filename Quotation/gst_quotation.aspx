<%@ Page Title="" Language="C#" MasterPageFile="~/Quotation/Quotation.master" AutoEventWireup="true" CodeFile="gst_quotation.aspx.cs" Inherits="Quotation_gst_quotation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i>GST Quotation</li>
            </ol>
        </section>
                        ...
                        <div class="card-body">
                            ...
                            <section class="invoice">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="control-label text-right col-md-2">Valid Date</label>
                                    <div class="col-md-2">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_amount" onkeydown="javascript:return false" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>
                                                <td>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_sqrft2" disabled="true" onkeydown="javascript:return false" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_amount2" disabled="true" class="form-control" onkeydown="javascript:return false" runat="server" TextMode="Number"></asp:TextBox></td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_total_amt2" onkeyup="gst();" onchange="gst();" onkeydown="javascript:return false" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>
                                            </tr>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_final_amt" onkeydown="javascript:return false" class="form-control" runat="server" TextMode="Number"></asp:TextBox></td>
                                            <td>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">
                                                    <asp:CheckBox ID="Chk_pasting" runat="server" />Pasting
                                                    <asp:CheckBox ID="Chk_framing" runat="server" />
                                                    Framing Charges:</th>

                                                <th scope="col">
                                                    <asp:CheckBox ID="Chk_fitting" runat="server" />Fitting
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="Txt_Dtp_charges" onkeyup="final_total();" class="form-control" runat="server" TextMode="Number" min="0" TabIndex="21"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="Txt_Pasting" onkeyup="final_total();" class="form-control" runat="server" TextMode="Number" min="0" TabIndex="22"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="Txt_Fitting" onkeyup="final_total();" class="form-control" runat="server" TextMode="Number" min="0" TabIndex="22"></asp:TextBox></td>
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <asp:TextBox ID="Txt_gst_no" placeholder="GST no." MaxLength="15" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    <script>
        function JSFunctionValidate() {
          ...
          <%--document.getElementById('<%=Btn_generate_pdf.ClientID%>').disabled = true--%>
            ;
            // $('#Btn_generate_pdf').prop("disabled",true);remove
