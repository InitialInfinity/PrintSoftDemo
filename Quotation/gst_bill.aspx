<%@ Page Title="" Language="C#" MasterPageFile="~/Quotation/Quotation.master" AutoEventWireup="true" CodeFile="gst_bill.aspx.cs" Inherits="admin_panel_Quotation_gst_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <ItemTemplate>
    <tr>
      <td>
          <asp:Label ID="lbl_product" runat="server" Text='<%# Eval("q_product_name") %>'></asp:Label><br /><asp:Label ID="Label3" runat="server" Text='<%# Eval("q_desc") %>'></asp:Label></td>
      <td><asp:Label ID="lbl_hsn" runat="server" Text='<%# Eval("q_hsn") %>'></asp:Label></td>
        <td><asp:Label ID="lbl_igst" runat="server" Text='<%# Eval("q_height") %>'></asp:Label> X <asp:Label ID="Label2" runat="server" Text='<%# Eval("q_width") %>'></asp:Label></td>
    ...
    <td><asp:Label ID="Label4" runat="server" Text='<%# Eval("q_unit") %>'></asp:Label></td>
      ...
      <td><asp:Label ID="lbl_cgst" runat="server" Text='<%# Eval("q_cgsta") %>'></asp:Label></td>

      <td><asp:Label ID="lbl_sgst" runat="server" Text='<%# Eval("q_sgsta") %>'></asp:Label></td>
        
      <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("q_igsta") %>'></asp:Label></td>
