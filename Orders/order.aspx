                        ...
                        <div class="card-body">
                            ...
                            <section class="invoice">
                                ...
                                <div class="customer_name row">
                                    <label class="control-label text-right col-md-3">Customer Name</label>
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="DropDownList1" class="form-control" runat="server" OnSelectedIndexChanged="Dd_customer_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                    ...
                                    <label class="control-label text-right col-md-3"></label>
                                    <div class="col-md-6">
                                       <asp:LinkButton ID="LinkButton3" data-toggle="modal" data-target="#myModal" class="col-md-4" runat="server">+Add Customer</asp:LinkButton>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <asp:DropDownList ID="DropDownList3" class="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Dd_enter_product_SelectedIndexChanged"></asp:DropDownList>
                                    <asp:LinkButton ID="LinkButton4" Class="add_class" data-toggle="modal" data-target="#myModal2" runat="server">+Add Product</asp:LinkButton>
                                    </div>
                                    <div class="col-md-6">
                                        <asp:TextBox ID="TextBox4" rows="2" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBox5" OnkeyUp="sqrft(); rate();quan_amount(); gst();" class="form-control" runat="server"></asp:TextBox></td>   
                                            <td>
                                                <asp:TextBox ID="TextBox6" OnkeyUp="sqrft(); rate();quan_amount(); gst();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox7" OnkeyUp="sqrft(); rate();quan_amount(); gst();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox8" Onkeyup="sqrft(); rate();quan_amount(); gst();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox9" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox10" OnkeyUp="sqrft(); rate();quan_amount(); gst();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox11" onkeyup="gst();" class="form-control" runat="server"></asp:TextBox></td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBox12"  disabled="true" class="form-control" runat="server"></asp:TextBox></td>   
                                            <td>
                                                <asp:TextBox ID="TextBox13" disabled="true" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox14" disabled="true"  class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox15" Onkeyup="quan_amount2(); gst2();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox16" disabled="true" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox17" OnkeyUp="quan_amount2(); gst2();" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox18" onkeyup="gst2();" class="form-control" runat="server"></asp:TextBox></td>
                                        </tr>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBox19" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox20" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox21" class="form-control" runat="server"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="TextBox22" class="form-control" runat="server"></asp:TextBox></td>
                                            <td><asp:Button ID="Button3" class="btn btn-primary pull-right" Style="margin-right: 5px;" runat="server" Text="Add to Cart" OnClick="Btn_cart_Click" /></td>
                                ...
                                <div class="row ">
                                    <div class="col-xs-12 table-responsive">
                                        <asp:GridView ID="GridView2" class="table table-striped" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnDataBound="GridView1_DataBound" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" >
                                ...
                                <div class="row m-t-3">
                                    <!-- accepted payments column -->
                                    <div class="col-lg-6">
                                        <p class="lead">Total Qty: <asp:Label ID="Label5" runat="server" Text=""></asp:Label></p>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Design Charges:</th>
                                                        <td>
                                                            <asp:TextBox ID="TextBox23" onkeyup="final_total();" class="form-control" runat="server" ></asp:TextBox></td>
                                                    </tr>
                                                  <tr>
                                                        <th>Transport:</th>
                                                        <td>
                                                            <asp:TextBox ID="TextBox24" onkeyup="final_total();" class="form-control" runat="server" ></asp:TextBox></td>
                                                    </tr>

                                                         <tr>
                                                        <th>Pasting  / Fitting / Framing Charges:</th>
                                                        <td>
                                                            <asp:TextBox ID="TextBox25" onkeyup="final_total();" class="form-control" runat="server" ></asp:TextBox></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <th>Advance:</th>
                                                        <td>
                                                            <asp:TextBox ID="TextBox26" onkeyup="final_total();" class="form-control" runat="server"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Discount:</th>
                                                        <td>
                                                            <asp:TextBox ID="TextBox27" onkeyup="final_total();" class="form-control" runat="server"></asp:TextBox></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <th>Balance Amount:</th>
                                                        <td class="grand_total">₹ <asp:Label ID="Label8" runat="server" Text=""></asp:Label></td>
                                                        
                                                    </tr>
                                                    <tr>
                                                        <th></th>
                                                        <td>
                                                            <asp:TextBox Class="Txt_hide" ID="TextBox28" runat="server"></asp:TextBox></td>
                                ...
                                <div class="row no-print">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Button ID="Button4" class="btn btn-success pull-right" runat="server" Text="Save & Close" OnClientClick="return JSFunctionValidate();" OnClick="Btn_submit_payment_Click" />
                                        <asp:Button ID="Button5" class="btn btn-primary pull-right" Style="margin-right: 5px;" runat="server" Text="Save Order" OnClientClick="return JSFunctionValidate();" OnClick="Btn_generate_pdf_Click" />
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
            ...
            <div class="form-body">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      ...
                      <asp:TextBox ID="TextBox29" placeholder="Customer Name"  class="form-control" runat="server"></asp:TextBox>
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="control-label text-right col-md-3">Address</label>
                    <div class="col-md-9">
                      <asp:TextBox ID="TextBox30" class="form-control"  placeholder="Address" runat="server" TextMode="MultiLine"></asp:TextBox>
          ...
          <asp:UpdatePanel ID="UpdatePanel6" runat="server">
              <ContentTemplate>
                   ...
                   <div class="form-group row">
                    <label class="control-label text-right col-md-3">Contact no.<span style="color:red;">*</span></label>
                    <div class="col-md-9">
                       <asp:TextBox ID="TextBox31"   placeholder="Contact no." class="form-control" runat="server"></asp:TextBox>
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="control-label text-right col-md-3">Opening Balance</label>
                    <div class="col-md-9">
                      <asp:TextBox ID="TextBox32" placeholder="Opening Balance" class="form-control" runat="server"></asp:TextBox>
                    </div>
                      </div>
                  ...
                  <div class="form-group row">
                    <label class="control-label text-right col-md-3">Email ID</label>
                    <div class="col-md-9">
                      <asp:TextBox ID="TextBox33" placeholder="Email ID" class="form-control" runat="server"></asp:TextBox>
                    </div>
                  </div>
        ...
        <div class="modal-footer">
             ...
             <asp:Button ID="Button6" class="btn btn-success" runat="server" Text="Submit" OnClientClick="JSFunctionValidate2();" OnClick="Button1_Click"  />
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
                  </ContentTemplate>
              </asp:UpdatePanel>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="form-body">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      ...
                      <asp:TextBox ID="TextBox34" placeholder="Product Name" class="form-control" runat="server"></asp:TextBox>
                      </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <label class="control-label text-right col-md-3">HSN Code</label>
                    <div class="col-md-9">
                       <asp:TextBox ID="TextBox35"  placeholder="HSN Code" class="form-control" runat="server"></asp:TextBox>
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="control-label text-right col-md-3">Rate (Rs)<span style="color:red;">*</span></label>
                    <div class="col-md-9">
                      <asp:TextBox ID="TextBox36"  placeholder="Rate" class="form-control" runat="server"></asp:TextBox>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="control-label text-right col-md-3">Description</label>
                    <div class="col-md-9">
                             <asp:TextBox ID="TextBox37" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                      </div>
                  </div>
        ...
        <div class="modal-footer">
             ...
             <asp:Button ID="Button7" class="btn btn-success" runat="server" OnClientClick="JSFunctionValidate3();" Text="Submit" OnClick="Button2_Click"  />
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
                    </ContentTemplate>
              </asp:UpdatePanel>
