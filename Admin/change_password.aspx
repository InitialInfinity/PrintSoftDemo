        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#profile2" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Add User</span></a> </li>
              <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#home2" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Change Password</span></a> </li>
              <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Add Role</span></a> </li>
            </ul>
            <!-- Tab panes -->
      ...
      <ItemTemplate> 
          <tr><td>
              ...
              <asp:Label ID="lbl_category_name" runat="server" Text='<%# Eval("au_role") %>'></asp:Label></td>
                  <td><asp:Label ID="lbl_date" runat="server" Text='<%# Eval("au_name") %>'></asp:Label></td>
              <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("au_email") %>'></asp:Label></td>
              <td><asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Do you want to delete this User?');" OnClick="DeleteUser"><i  class="fa fa-trash-o"></i></asp:LinkButton>
...
<div class="tab-pane p-20" id="profile3" role="tabpanel">
      ...
      <ItemTemplate> 
          <tr><td>
              ...
              <asp:Label ID="lbl_category_name" runat="server" Text='<%# Eval("ar_name") %>'></asp:Label></td>
                  <td><asp:Label ID="lbl_date" runat="server" Text='<%# Eval("ar_date","{0:MM/dd/yyyy}") %>'></asp:Label></td>
                 <td><asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Do you want to delete this Role?');" OnClick="DeleteRole"><i style="padding-left:10px" class="fa fa-trash-o"></i></asp:LinkButton></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title"><asp:Label ID="lbl_user" runat="server" Text=""></asp:Label></h4>
  ...
  <tbody>
    <tr>
      ...
      <td><asp:Label ID="lbl_role" runat="server" Text=""></asp:Label></td>
      ...
      <td><asp:Label ID="lbl_password" type="password" runat="server" Text=""></asp:Label></td>
  ...
  <tbody>
      <tr>
      <th scope="col">User<span style="color:red;">*</span></th>
      <td>
    ...
    <tr>
      ...
      <td>  <asp:DropDownList ID="Dd_role2" class="form-control" runat="server"></asp:DropDownList></td>
     
    </tr>
       <tr>
      <th scope="col">Email<span style="color:red;">*</span></th>
      <td><asp:TextBox ID="Txt_email2" CssClass="form-control" runat="server"></asp:TextBox></td>
     
    </tr>
       <tr>
      <th scope="col">Password<span style="color:red;">*</span></th>
      <td><asp:TextBox ID="Txt_password2" type="password" CssClass="form-control" runat="server"></asp:TextBox></td>
