...
public partial class admin_panel_Purchase_list_of__purchase : System.Web.UI.Page
{
    ...
    protected void excel_export(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=List of Purchase Invoice-" + date + ".xls");
    ...
    protected void pdf_export(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=List of Purchase Invoice-" + date + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
