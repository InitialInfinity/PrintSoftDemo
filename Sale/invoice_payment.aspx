<%@ Page Title="" Language="C#" MasterPageFile="~/Sale/Sale.master" AutoEventWireup="true" CodeFile="invoice_payment.aspx.cs" Inherits="Sale_invoice_payment" %>
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lbl_customer" runat="server" Text='<%# Eval("c_name") %>'></asp:Label></td>
                                                        <td>
