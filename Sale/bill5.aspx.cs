...
public partial class Sale_bill5 : System.Web.UI.Page
{
    ...
    public void fill()
    {
        cmd2 = new SqlCommand("select * from tbl_sale_invoice inner join tbl_customer on tbl_sale_invoice.c_id=tbl_customer.c_id where s_invoice_no ='" + invoice + "'", conn);
        ...
        if (dt1.Rows.Count > 0)
        {
            ...
            //lbl_order_no.Text = dt1.Rows[0]["es_order_no"].ToString();
            lbl_invoice_date.Text = Convert.ToDateTime(dt1.Rows[0]["s_invoice_date"]).ToString("dd/MM/yyyy");
            //lbl_due_date.Text = Convert.ToDateTime(dt1.Rows[0]["es_due_date"]).ToString("dd/MM/yyyy");
            ...
            //lbl_shipping.Text = dt1.Rows[0]["es_shipping_charges"].ToString();
        ...
        cmd3 = new SqlCommand("select sum(s_stotal) from tbl_sale_invoice where s_invoice_no ='" + invoice + "'", conn);
    ...
    protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
        {
            ...
            decimal h = Convert.ToDecimal(drv["s_height"]);
            decimal w = Convert.ToDecimal(drv["s_width"]);
