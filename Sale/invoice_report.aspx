      ...
      <div class="row">
        <div class="col-md-3">
         <h4 class="text-black">Sales Report</h4>
           ...
           <a href="sale_invoice.aspx"><button type="button" id="btn_mail"  title="Create New Invoice" class="btn btnsqr btn-primary4 btngap"> <i class="fa fa-plus"></i>Add Invoice</button></a>
       ...
       <div id="dropHere" class="table-responsive">
          ...
          <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
              ...
              <asp:Label ID="lbl_invoice" runat="server" Text='<%# Eval("sl_invoice_no") %>'></asp:Label></a></td>
                       <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>">
              <asp:Label ID="lbl_invoice_date" runat="server" Text='<%# Eval("sl_invoice_date" , "{0:dd/MM/yyyy}") %>'></asp:Label></a></td>
                ...
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_cust_name" runat="server" Text='<%# Eval("c_name") %>'></asp:Label></a></td>
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_status" runat="server" Text=''></asp:Label></a></td>
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_payment" runat="server" Text='<%# Eval("sl_payment_method") %>'></asp:Label></a></td>
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_discount" runat="server" Text='<%# Eval("sl_discount") %>'></asp:Label></a></td>
                <td><a href="wgst_bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="Label1" runat="server" Text='<%# Eval("sl_adjustment") %>'></asp:Label></a></td>
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_balance" runat="server" Text='<%# Eval("sl_balance") %>'></asp:Label></a></td>
                <td><a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><asp:Label ID="lbl_total" runat="server" Text='<%# Eval("sl_total") %>'></asp:Label></a></td>
              ...
              <%--   <a href="bill.aspx?invoice=<%# Eval("sl_invoice_no") %>"><i style="padding-left:10px" class="fa fa-eye"></i></a>--%>
                 ...
                 <tfoot>
                  ...
                  <th></th>
                  <th>Total :</th>
                   <th>   <asp:Label ID="lbldiscount" runat="server" ></asp:Label> </th>
