...
public partial class Sale_bill4 : System.Web.UI.Page
{
    ...
    public void fill()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lbl_total_cgst.Text = dt.Compute("Sum(s_cgsta)", string.Empty).ToString();
            lbl_total_sgst.Text = dt.Compute("Sum(s_sgsta)", string.Empty).ToString();
            ...
            lbl_total_amt.Text = dt.Compute("Sum(s_total)", string.Empty).ToString();
