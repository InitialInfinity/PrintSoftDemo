<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wgst_bill2.aspx.cs" Inherits="Sale_wgst_bill2" %>
<!DOCTYPE html>
                    ...
                    <td>
                        ...
                        <table  width='900' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' style='border-radius: 0px; '>
                            <tbody>
                              ...
                              <%--   <tr>
                                    <td style="padding:0px 20px 0px 20px;">
                                        <table width='100%' border='0' cellspacing='2' cellpadding='0' style='border-bottom:solid 2px #bf0707;'>
                                            <tbody>
                                                <tr>
                                                    <td align='left' valign='top' style='padding:0px 5px 0px 5px'>
                                                        <table height='auto' width='230' border='0' cellpadding='2' cellspacing='2'>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width='100' align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 3px 5px'>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width='62' align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 3px 5px'>
                                                                        <asp:Label ID="lbl_ac" runat="server" Text=""></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 0px 3px 0px'>
                                                                        <strong>Bank Branch IFSC:</strong>
                                                                    </td>
                                                                    <td width='62' align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 3px 5px'>
                                ...
                                <tbody>
                                   <asp:Repeater ID="Repeater1" runat="server">
                                     <ItemTemplate>
                                    <tr class="table_td">
                                        <td><strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("es_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("es_desc") %>'></asp:Label> </td>
                                        ...
                                        <td><asp:Label ID="Label4" runat="server" Text='<%# Eval("es_unit") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("es_quantity") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("es_rate") %>'></asp:Label></td>
                                        <td><asp:Label ID="lbl_stotal" runat="server" Text='<%# Eval("es_stotal") %>'></asp:Label></td>
                                    </tr>
                                   </ItemTemplate>
                                  </asp:Repeater>
                                </tbody>
                                            ...
                                            <tbody>
                                	          ...
                                	          <td style="height: 50px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='color:#404041;text-align: center; font-size:14px;line-height:16px;border-top: 1px solid #cbdbcd; padding:0px 18px 10px 10px'>
                                                        <p>
                                               ...
                                               <%-- <tr>
                                                ...
                                                <!--<tr>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_transport" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                 ...
                                                 <asp:Panel ID="Panel2" runat="server">
                                                  <tr>
                                                    ...
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_dtp" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                     </asp:Panel>
                                                <asp:Panel ID="Panel3" runat="server">
                                                  <tr>
                                                    <td align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 0px 5px 0px'>
                                                        <strong>Pasting Charges</strong>
                                                    </td>
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_pasting" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                     </asp:Panel>
                                                 <asp:Panel ID="Panel4" runat="server">
                                                  <tr>
                                                    <td align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 0px 5px 0px'>
                                                        <strong>Framing Charges</strong>
                                                    </td>
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_framing" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                      </asp:Panel>
                                                 <asp:Panel ID="Panel5" runat="server">
                                                  <tr>
                                                    <td align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 0px 5px 0px'>
                                                        <strong>Fitting Charges</strong>
                                                    </td>
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_fitting" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                      </asp:Panel>
                                                  ...
                                                  <tr>
                                                    <td align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 0px 5px 0px'>
                                                        <strong>Intallation Charges</strong>
                                                    </td>
                                                    <td width='auto' align='right' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 5px 5px'>
                                                        ₹ <asp:Label ID="lbl_install" runat="server" Text=""></asp:Label>
                                                    </td>
                                                </tr>
                                                       </asp:Panel>
                                                <tr>
