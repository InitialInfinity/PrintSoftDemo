<%@ Page Title="" Language="C#" MasterPageFile="~/Sale/Sale.master" AutoEventWireup="true" CodeFile="SaleBulkPayment.aspx.cs" Inherits="Sale_SaleBulkPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <section class="content-header sty-one">
            <h1>Sale Bulk Payment</h1>
            <ol class="breadcrumb">
                <li><a href="#">Sale</a></li>
                <li><i class="fa fa-angle-right"></i>Sale Bulk Payment</li>
            </ol>
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <h4 class="text-black">Sale Bulk Payment</h4>
                        </div>
                                    ...
                                    <div class="modal-dialog custom-modal-width" style="max-width: 800px; width: 100%; margin: 87px auto;">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Sale Bulk Payment<asp:HiddenField ID="Txt_id" runat="server" />
                                                </h4>
