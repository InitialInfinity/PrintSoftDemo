<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wgst_bill3.aspx.cs" Inherits="Sale_wgst_bill3" %>
...
<body>
	...
	<tr>
	<td width="24%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/>Product<br/></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/>Size<br/></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/>Unit<br/></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/>Qty<br/></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/>Rate<br/></td>
    <td width="8%" style="border-top:1px solid;  text-align:center; height:20px;"><br/>Total<br/></td>
	</tr>
	</table>
	</td>
	</tr>
	...
	<table cellspacing="0" cellpadding="0" width="100%">
        <asp:Repeater ID="Repeater1" runat="server">
                                     <ItemTemplate>
	<tr>
	<td width="24%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><br/><strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("es_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("es_desc") %>'></asp:Label> </td>

	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><asp:Label ID="lbl_height" runat="server" Text='<%# Eval("es_height") %>'></asp:Label> X <asp:Label ID="lbl_width" runat="server" Text='<%# Eval("es_width") %>'></asp:Label></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><asp:Label ID="Label4" runat="server" Text='<%# Eval("es_unit") %>'></asp:Label></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("es_quantity") %>'></asp:Label></td>
	<td width="8%" style="border-top:1px solid; border-right:1px solid; text-align:center; height:20px;"><asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("es_rate") %>'></asp:Label></td>
    <td width="8%" style="border-top:1px solid;  text-align:center; height:20px;"><asp:Label ID="lbl_stotal" runat="server" Text='<%# Eval("es_stotal") %>'></asp:Label></td>
	</tr>
                                           </ItemTemplate>
                                  </asp:Repeater>
	</table>
