<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wgst_bill4.aspx.cs" Inherits="Sale_wgst_bill4" %>
...
<body class="A4">
  ...
  <div class="wrapper">
    <div class="row margin-0">
      <div class="col-sm-5">
        <p class="top-head"><b>NON GST INVOICE</b></p>
      </div>
      ...
      <div class="col-sm-12 padding-0">
        <table class="invoice-bill">
          ...
          <tr class="product_deatils_table">
            <td>
              <asp:Label ID="lbl_id" runat="server" Text='<%# Eval("es_id") %>'></asp:Label>
            </td>
            <td>
              <p>
                <strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("es_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("es_desc") %>'></asp:Label> 
              </p>
            </td>
            <td>
              <p><asp:Label ID="lbl_hsn" runat="server" Text='<%# Eval("es_hsn") %>'></asp:Label></p>
            </td>
            <td>
              <p>
                <asp:Label ID="lbl_height" runat="server" Text='<%# Eval("es_height") %>'></asp:Label> X <asp:Label ID="lbl_width" runat="server" Text='<%# Eval("es_width") %>'></asp:Label>
              </p>
            </td>
            <td>
              <p>
                <asp:Label ID="Label4" runat="server" Text='<%# Eval("es_size") %>'></asp:Label>
              </p>
            </td>
            <td>
              <p>
               <asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("es_rate") %>'></asp:Label>
              </p>
            </td>
            <td>
              <p>
                <asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("es_quantity") %>'></asp:Label>
              </p>
            </td>
            <td>
              <p>
                <asp:Label ID="lbl_amount" runat="server" Text='<%# Eval("es_samount") %>'></asp:Label>
              </p>
            </td>
          <td>
              <p>
