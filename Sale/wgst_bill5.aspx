<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wgst_bill5.aspx.cs" Inherits="Sale_wgst_bill5" %>
 ...
 <ItemTemplate>
    <tr class="service">
      <td style="padding:6px">
          <asp:Label ID="lbl_product" runat="server" Text='<%# Eval("es_product_name") %>'></asp:Label></td>
    
        <td style="padding:6px"><asp:Label ID="lbl_height" runat="server" Text='<%# Eval("es_height") %>'></asp:Label> <asp:Label ID="Label1" runat="server" Text="x"></asp:Label> <asp:Label ID="lbl_width" runat="server" Text='<%# Eval("es_width") %>'></asp:Label></td>
     
   
          <td style="padding:6px"><asp:Label ID="lbl_qty" runat="server" Text='<%# Eval("es_quantity") %>'></asp:Label></td>
       
      <td style="padding:6px"><asp:Label ID="lbl_rate" runat="server" Text='<%# Eval("es_rate") %>'></asp:Label></td>
      <td style="padding:6px"><asp:Label ID="lbl_stotal" runat="server" Text='<%# Eval("es_stotal") %>'></asp:Label></td>
