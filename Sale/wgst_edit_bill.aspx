                        ...
                        <div class="card-body">
                            ...
                            <section class="invoice">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="Dd_customer" class="form-control" disabled="true" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:TextBox ID="Txt_order_no" class="form-control" runat="server" disabled="true"></asp:TextBox>
                                    </div>
                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Txt_dtp_charges" onkeyup="final_total();" class="form-control" runat="server" disabled="true"></asp:TextBox></td>
                                                    </tr>
                                                  <tr>
                                                        <th>Transport:</th>
                                                        <td>
                                                            <asp:TextBox ID="Txt_shipping" onkeyup="final_total();" class="form-control" runat="server" disabled="true"></asp:TextBox></td>
                                                    </tr>

                                                         <tr>
                                                        <th>Pasting  / Fitting / Framing Charges:</th>
                                                        <td>
                                                            <asp:TextBox ID="Txt_Fitting_Framing" onkeyup="final_total();" class="form-control" runat="server" disabled="true"></asp:TextBox></td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        <th>Advance:</th>
                                                        <td>
                                                            <asp:TextBox ID="Txt_advance" onkeyup="final_total();" onchange="final_total();"  class="form-control" runat="server" TextMode="Number" TabIndex="19" disabled="true"></asp:TextBox></td>
                                                    </tr>
                                                     <tr>
                                                        <th>Discount:</th>
                                                        <td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="drp_payment"  class="form-control"  runat="server" TabIndex="21" disabled="true">
                                                    ...
                                                    <tr>
                                                        <th>Balance :</th>
                                                        <td>               <asp:Label ID="lbl_Final_Balance" runat="server" ></asp:Label></td>
                                                    </tr>
                                                                               <tr>
    ...
    <script type="text/javascript">
        ...
        <%--  function final_total() {
            ...
            var dtp_charges_value = parseFloat(dtp_charges.value);
                    ...
                    var Fitting_Framing = document.getElementById('<%=Txt_Fitting.ClientID %>');
