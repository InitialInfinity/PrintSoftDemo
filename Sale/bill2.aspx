                            ...
                            <tbody>
                                ...
                                <tbody>
                                   <asp:Repeater ID="Repeater2" runat="server">
                                     <ItemTemplate>
                                    <tr class="table_td">
                                        <td><strong><asp:Label ID="lbl_product" runat="server" Text='<%# Eval("s_product_name") %>'></asp:Label></strong><br/><asp:Label ID="Label1" runat="server" style="font-size: 12px;" Text='<%# Eval("s_desc") %>'></asp:Label> </td>
                                        ...
                                        <td><asp:Label ID="lbl_igst" runat="server" Text='<%# Eval("s_igstp") %>'></asp:Label></td>
                                                        ...
                                                        <table height='auto' width='230' border='0' cellpadding='2' cellspacing='2'>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width='150' align='left' valign='top' style='color:#404041;font-size:14px;line-height:16px;padding:5px 5px 3px 5px'>
