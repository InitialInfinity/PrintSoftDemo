                            ...
                            <section class="invoice">
                                ...
                                <table class="table">
                                    <asp:Panel ID="Panel1" runat="server">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txt_width" OnkeyUp="sqrft(); rate();quan_amount(); " onchange="sqrft(); rate(); quan_amount(); " class="form-control" runat="server" TextMode="Number" TabIndex="9"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txt_height" OnkeyUp=" sqrft(); rate();quan_amount();" onchange="sqrft(); rate(); quan_amount(); " class="form-control" runat="server" TextMode="Number" TabIndex="10"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txt_sqrft" OnkeyUp="sqrft(); rate(); quan_amount(); " onchange="sqrft(); rate(); quan_amount(); " class="form-control" runat="server" TextMode="Number" TabIndex="11"></asp:TextBox></td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_quantity" OnkeyUp="sqrft(); rate();quan_amount();" onchange="sqrft(); rate(); quan_amount(); " class="form-control" runat="server" TextMode="Number" TabIndex="14"></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txt_total_amt"  onchange=" " class="form-control" runat="server" TextMode="Number" TabIndex="15"></asp:TextBox></td>
                                            </tr>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align: right;">
                                                <asp:LinkButton ID="Btn_cart" Style="margin-right: 5px;" OnClientClick="return JSFunctionValidate4();" OnClick="Btn_cart_Click" runat="server"><i style="padding-left:10px; font-size:40px;" class="fa fa-plus-circle" tabindex="15"></i></asp:LinkButton>
                                            </th>
                                ...
                                <div class="row no-print">
                                    <div class="col-lg-11 py-4">
                                        ...
                                        <asp:Button ID="Btn_submit_payment" class="btn btn-success pull-right submitBtn" runat="server"  Text="Save & Close" OnClick="Btn_submit_payment_Click" TabIndex="23" />
                                        <asp:Button ID="Btn_generate_pdf" class="btn btn-primary pull-right" Style="margin-right: 5px;" runat="server" Text="Save Cash Memo" OnClientClick="return  preventMultipleSubmissions(); JSFunctionValidate();"   OnClick="Btn_generate_pdf_Click" TabIndex="22" />
