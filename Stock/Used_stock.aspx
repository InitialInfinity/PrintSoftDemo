<%@ Page Title="" Language="C#" MasterPageFile="~/Stock/Stock.master" AutoEventWireup="true" CodeFile="Used_stock.aspx.cs" Inherits="Stock_Used_stock" %>
     ...
     <%--    <button type="button" id="btn_pdf" title="Export to PDF" runat="server"  class="btn btnsqr btn-primary2" onserverclick="pdf_export"> <i class="fa fa-file-pdf-o"></i> PDF</button>--%>
      ...
      <div id="dropHere" class="table-responsive">
              ...
              <asp:Label ID="lblRowNumber" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></td>
                      <%--  <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("date") %>'></asp:Label></td>--%>
                       <%--<td>
              ...
              <asp:Label ID="lbl_product_name" runat="server" Text='<%# Eval("p_name") %>'></asp:Label></td>
                      <%--  <td><strong><asp:Label ID="Label1" runat="server" Text='<%# Eval("sqrft") %>'></asp:Label><strong/></td>--%>
                       <td><asp:Label ID="lbl_quantity" runat="server" Text='<%# Eval("quantity") %>'></asp:Label></td>
                ...
                <%--  <td><asp:Label ID="lbl_cgst" runat="server" Text='<%# Eval("p_cgst") %>'></asp:Label></td>
                  ...
                  <asp:LinkButton ID="LinkButton2" runat="server"  CommandName="showid" CommandArgument='<%# Eval("p_name") %>'><i style="padding-left:10px" class="fa fa-eye"></i></i></asp:LinkButton>
                  <%--<asp:LinkButton ID="LinkButton3" runat="server" CommandName="editid" CommandArgument='<%# Eval("p_name") %>'><i style="padding-left:10px" class="fa fa-edit"></i></asp:LinkButton>--%>
      ...
      <div id="dropHere2" class="table-responsive">
              ...
              <ItemTemplate>
                   <tr>
                  <td>
              <asp:Label ID="lblRowNumber1" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></td>
                        <%--<td><asp:Label ID="Label2" runat="server" Text='<%# Eval("date") %>'></asp:Label></td>--%>
                  <td>
              <asp:Label ID="lbl_product_name" runat="server" Text='<%# Eval("p_name") %>'></asp:Label></td>
                        <%--<td><strong><asp:Label ID="Label1" runat="server" Text='<%# Eval("sqrft") %>'></asp:Label><strong/></td>--%>
  ...
  <tbody>
    ...
    <tr>
     ...
     <%--  <tr>
      ...
      <td><asp:Label ID="lbl_sqrft" runat="server" Text=""></asp:Label></td>
