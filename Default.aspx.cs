...
public partial class _Default : System.Web.UI.Page
{
    ...
    decimal damsale, damest, dbalsale, dbalest, dsqsale, dsqest, dbaladv, dbalead;
    ...
    protected void FillDaily()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            dbaladv = Convert.ToDecimal(dt.Compute("Sum(sl_adjustment)", string.Empty));
        }
        else
        {
            damsale = 0;
        ...
        if (dt2.Rows.Count > 0)
        {
            ...
            dbalead = Convert.ToDecimal(dt2.Compute("Sum(est_adjustment)", string.Empty));
        }
        else
        {
            damest = 0;
        ...
        decimal ad = Convert.ToDecimal((dbaladv + dbalead).ToString());
        lbl_daily_advance.Text = ad.ToString("N", inr);
