<%@ Page Title="" Language="C#" MasterPageFile="~/Settings/Settings.master" AutoEventWireup="true" CodeFile="offer_messages.aspx.cs" Inherits="admin_panel_Settings_offer_messages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header sty-one">
      <h1>Offer Messages</h1>
      <ol class="breadcrumb">
        <li><a href="#">Settings</a></li>
        <li><i class="fa fa-angle-right"></i> Offer Messages</li>
      </ol>
    </section>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Offer Messages</h5>
            </div>
            <div class="card-body">
                ...
                <div class="form-body">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      ...
                      <asp:TextBox ID="Txt_message" placeholder="Enter Offer Message" rows="4"  class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                      </div>
                  </div>
